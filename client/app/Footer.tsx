...
import footerStyles from '../public/styles/footer.module.css'
                ...
                <div className={footerStyles.content}>
                    <div className={footerStyles.top}>
                        <div className={footerStyles['logo-details']}>
                            ...
                            <span className={footerStyles.logo_name}>Jhimruk Innovative Technology Center</span>
                        </div>
                        <div className={footerStyles[`media-icons`]} style={{textAlign:'center'}}>
